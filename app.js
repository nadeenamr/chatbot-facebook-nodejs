	...
	switch (action) {
		...
		case "welcomeUser":
				students.newOrRegularStudent(function(isRegular){
					let reply;
					if(isRegular[0]=="new"){
						reply = "Welcome "+ isRegular[1] +"! "+emoji.get('wave')+" I'm your MET Mentor! I can answer any questions you might have and offer support/advice for MET students. Please enter your GUC ID so I am able to access your records."; 
						sendTextMessage(sender, reply);
						sendGifMessage("https://giphy.com/gifs/cbc-schittscreek-schitts-creek-88iGfhImcQ7mkbyuiS",sender);
					}else{
						if(isRegular[0]=="old"){
							reply = "Welcome back "+ isRegular[1] +" "+emoji.get('wave')+" ! How can I help you today? "+emoji.get('woman_office_worker');
