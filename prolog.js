...
/*------ cs_semester(semester_number,semester_total_credithours) ------*/
/*------ lang_course(language,course_number,course_code,course_credithours) ------*/
/*------ cs_course(course_code,semester,course_credit_hours) ------*/
/*------ cs_semester_courses(semester_num,courses_list) ------*/
/*------ cs_collective_credithours(courses_list,total_credithours) ------*/
/*------ dmet_course(course_code,semester,course_credit_hours) ------*/
/*------ dmet_semester_courses(semester_num,courses_list) ------*/
/*------ dmet_collective_credithours(courses_list,total_credithours) ------*/
/*------ prereq(course_code,prereq_code) ------*/
/*------ student(student_id,student_name,major,student_semeter) ------*/
/*------ failed_course(student_id,course_id) ------*/
/*------ taken_course(student_id,course_id) ------*/
...
session.query(scheduleQuery); // Query the goal
